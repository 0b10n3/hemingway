...
![Ilustração: um radar de rodovia mede a velocidade média de um carro entre dois sensores e a trata como se fosse instantânea](ilu-01)
...
![Diagrama: o ciclo de liquidez que derrubou o LTCM, do calote russo à venda forçada que piora ainda mais o próprio preço](diag-01)
